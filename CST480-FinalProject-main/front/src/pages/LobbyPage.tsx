...
const LobbyPage: FC = () => {
    ...
    const columns: ColumnsType<RoomStatus> = [
        ...
        },
        {
            ...
            dataIndex: 'status',
            align: 'center',
            render: (status: boolean) => (status ? 'In progress' : 'Waiting for players'),
        },
        {
            title: 'Join',
            dataIndex: '',
        ...
        <>
            <div className="lobby-container">
                <div className="header-container">
                    <Link to="/Home">
                        <Button type="text" style={{ width: 175, height: 75, fontSize: 40, marginTop: '25px'}} >
                            <RollbackOutlined />
                            Back
                        </Button>
                    </Link>
                ...
                <div className="room-select-container">
                    <Space style={{ marginBottom: 50}}>
                        <img style={{ width: 60, height: 60, marginRight: 20 }} src={icon} alt="logo" />
                        <Typography style={{ fontSize: 40, fontWeight: "bold" }}>Draw & Guess</Typography>
                    </Space>
                    <Typography style={{ fontSize: 25, fontWeight: "bold", textAlign: "center" }}>Select a room to join</Typography>
                    ...
                    <Space>
                        <Button type="primary" className="action-button" onClick={handleOnPlayNowBtnClick}>
                            Play Now!
                        </Button>
                        
                        <RoomCreateModal handleOnCreateRoomBtnClick={handleOnCreateRoomBtnClick} />
                    </Space>
                    <Space>
